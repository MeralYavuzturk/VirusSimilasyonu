...
📖 Kullanım Senaryosu
Enfeksiyon: Uygulama açıldığı anda mouse kontrolü devre dışı kalır ve imleç merkeze sabitlenir.

Müdahale: Kullanıcı klavyeden Enter tuşuna basarak "Sistemi Tara ve Temizle" komutunu verir.

Analiz: Antivirüs süreci tarar, zararlı iş parçacığını öldürür ve kullanıcıya görsel geri bildirim (MessageBox) verir.

Sonuç: "SİSTEM TEMİZLENDİ" onayı alındıktan sonra program güvenli bir şekilde kapanır ve mouse serbest kalır.
